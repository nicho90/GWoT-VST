			                ...
			                client.query("SELECT * FROM Users WHERE username=$1;", [
			                    ...
			                    if(err) {
			                        ...
			                        if(result.rows.length === 0) {
										...
										// Database Query
										client.query("INSERT INTO Thresholds (created, updated, creator, description, warning_threshold, critical_threshold, category) VALUES (now(), now(), $1, $2, $3, $4, $5);",
											[
												req.params.username,
												req.body.description,
												req.body.warning_threshold,
												req.body.critical_threshold,
												req.body.category
											], function(err, result) {
											done();
											...
											if(err) {
												...
												var query = "SELECT " +
														...
														"description, " +
														"warning_threshold, " +
														"'CENTIMETER' AS warning_threshold_unit, " +
														"critical_threshold, " +
														"'CENTIMETER' AS critical_threshold_unit, " +
														"category " +
													"FROM Thresholds WHERE creator=$1 " +
