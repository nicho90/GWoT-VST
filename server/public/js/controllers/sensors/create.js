...
// CREATE
app.controller("SensorCreateController", function($scope, $rootScope, $location, $translate, $filter, $sensorService, $waterBodyService, $verificationService, config) {
    ...
    $scope.load = function(){
        ...
        // New Sensor
        $scope.sensor = $sensorService.getDefault();
        ...
        $scope.markers.push({
            ...
            message: '<center>{{ \'NEW_SENSOR\' | translate }}</center>',
    ...
    $scope.create = function(){
        $sensorService.user_create($rootScope.authenticated_user.token, $rootScope.authenticated_user.username, $scope.sensor).success(function(response){
